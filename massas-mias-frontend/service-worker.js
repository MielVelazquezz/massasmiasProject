    ...
    event.waitUntil(
        caches.open('massas-mias-cache').then((cache) => {
            const filesToCache = [
                ...
                '/static/css/pizza.css',
                '/static/css/index.css',
                '/static/css/home.css',
                '/static/css/cadastro.css',
                '/static/adm/css/listaPedidos.css',
                '/static/adm/css/mesas.css',
                '/static/adm/css/pagina-principal.css',
                '/static/adm/css/style.css',
                '/static/adm/css/styleadm.css',
                '/static/adm/css/styleresponsive.css',
